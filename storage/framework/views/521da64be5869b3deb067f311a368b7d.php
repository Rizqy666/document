                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="client" name="client"
                                    value="<?php echo e($document->client); ?>" required>
                            </div>
                            <div class="mb-3">
                                <label for="project_name" class="form-label">Project Name</label>
                                <input type="text" class="form-control" id="project_name" name="project_name"
                                    value="<?php echo e($document->project_name); ?>" required>
                            </div>
                            <div class="mb-3">
                                <label for="discipline" class="form-label">Discipline</label>
                                <input type="text" class="form-control" id="discipline" name="discipline"
                                    value="<?php echo e($document->discipline); ?>" required>
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="document_category"
                                    name="document_category" value="<?php echo e($document->document_category); ?>" required>
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="document_drawing" name="document_drawing"
                                    value="<?php echo e($document->document_drawing); ?>" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <!-- Menampilkan tombol "Lihat PDF" jika ada file PDF yang sudah di-upload -->
                                <?php if($document->pdf): ?>
                                    <div class="mt-2" id="pdf-link">
                                        <span class="text-success">
                                            <a href="<?php echo e(asset('storage/' . $document->pdf)); ?>" target="_blank">Lihat
                                                PDF</a>
                                        </span>
                                    </div>
                                <?php else: ?>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="document_title" name="document_title"
                                    value="<?php echo e($document->document_title); ?>" required>
                            </div>
                            <div class="mb-3">
                                <label for="revision" class="form-label">Revision</label>
                                <input type="text" class="form-control" id="revision" name="revision"
                                    value="<?php echo e($document->revision); ?>" required>
                            </div>
                            <div class="mb-3">
                                <label for="status" class="form-label">Status</label>
                                <input type="text" class="form-control" id="status" name="status"
                                    value="<?php echo e($document->status); ?>" required>
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="revision_date" name="revision_date"
                                    value="<?php echo e($document->revision_date); ?>" required>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    function uploadFile() {
        ...
        xhr.open('POST', '<?php echo e(route('documents.update', $document->id)); ?>',
        true); // Pastikan menggunakan route yang sesuai
        xhr.setRequestHeader('X-CSRF-TOKEN', '<?php echo e(csrf_token()); ?>'); // Token CSRF
        ...
        // Saat upload selesai, sembunyikan progress bar dan tampilkan status
        xhr.onload = function() {
            if (xhr.status == 200) {
                uploadStatus.innerText = 'Upload selesai!';
                uploadStatus.style.display = 'block';

                // Menampilkan link "Lihat PDF" setelah berhasil upload
                document.getElementById('pdf-link').style.display = 'block';
                document.getElementById('no-pdf-message').style.display = 'none';
                document.getElementById('progress-bar').style.display = 'none'; // Sembunyikan progress bar
            } else {
...
<?php /**PATH C:\laragon\www\document\resources\views/modals/edit_document.blade.php ENDPATH**/ ?>